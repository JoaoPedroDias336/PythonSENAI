...
while True: 
    ...
    if opcao == 1:
        ...
        for nome in pais:
            resposta = inputs.input_str(f"{nome} está presente? (s/n): ")
            if resposta == 's':
